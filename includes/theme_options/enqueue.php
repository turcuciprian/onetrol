...
add_action('wp_enqueue_scripts', 'onetrol_enqueue_scripts');

//Registering scripts and styles for the theme
function onetrol_enqueue_scripts() {
    //Javascript
    ...
    wp_enqueue_script('selectivizr', get_template_directory_uri() . '/js/selectivizr-min.js', array(), '1.0.0', true);
    wp_enqueue_script('respond', get_template_directory_uri() . '/js/dest/respond.min.js', array(), '1.0.1', true);
    //ie8 compatibility for HTML5 - html5shiv script
    wp_enqueue_script('html5shiv', 'http://html5shiv.googlecode.com/svn/trunk/html5.js', array(), '1.0.0', false);
...
//    Google fonts
    wp_enqueue_style('google-fonts', 'http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,400,300,600,700,800|Open+Sans+Condensed:300|Dosis:200,300,400,500,600,700,800', '1.0.0', true);
