...
//side meta box generator array settings
$mbg_array = array();
$mbg_array = array(
    'side' => array(
        'section_type' => 'animations',
        'section_name' => 'cs_side_metabox_name',
        'section_image' => 'none',
        'fields' => array(
            0 => array(
                'type' => 'radio_special',
                ...
                'description' => 'Activate Animations?',
                'options' => array(
                    0 => 'Yes',
                    1 => 'No'
                )
...
$options_page_arr = array(
    ...
    'sections' => array(
        ...
        1 => array(
            ...
            'fields' => array(
                ...
                2 => array(
                    ...
                    'value' => 1,
                    'options' => array(
                        0 => 'Default (Logo left, menu right)',
                        1 => 'Reversed (logo right, menu left)',
                        2 => 'Centered (everything centered)'
                    )
                )
            )
        ),
        2 => array(
            'id' => 'footer',
            'title' => 'The Footer',
            'description' => 'Everything that has to do with the footer',
            'fields' => array(
                0 => array(
                    'id' => 'footer_text',
                    'title' => 'Footer Text',
        ...
        3 => array(
            ...
            'description' => 'Load the dummy data<br/>WARNING! Do not press this unless you want to generate demo dummy data. Your menu will be replaced!',
            'fields' => array(
                0 => array(
                    'id' => 'ajax_submit',
                    'title' => 'Load data',
